...
export function TopToolbar() {
  ...
  return (
    <div className="flex h-12 shrink-0 items-center gap-1 overflow-x-auto border-b border-separator bg-toolbar px-2 md:h-11 md:overflow-visible [&::-webkit-scrollbar]:h-0">
      ...
      <button
        type="button"
        className="ml-1 flex h-9 shrink-0 items-center gap-1.5 rounded bg-success px-3 text-[11px] font-semibold uppercase tracking-wide text-window transition-opacity hover:opacity-90 md:h-7"
      >
